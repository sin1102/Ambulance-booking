...
import com.example.ambulancebooking.databinding.ActivityNewMapBinding
import com.example.ambulancebooking.map.app.navigation.ActiveGuidanceFragment
import com.example.ambulancebooking.map.app.navigation.AppNavigationCamera
import com.example.ambulancebooking.map.app.navigation.AppRouteLine
import com.example.ambulancebooking.map.app.routerequest.MapLongClickRouteRequest
import com.example.ambulancebooking.map.app.search.SearchFragment
...
class NewMap : AppCompatActivity(), PermissionsListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mapView.location.apply {
            locationPuck = CarLocationPuck.navigationPuck2D(this@NewMap)
            enabled = true
            pulsingEnabled = true
